...
?>
	...
	<input type="hidden" name="dateformat" value="<?php echo $date_format ?>">
		...
		<td class=small >
			...
			<input name="visibility" value="Public" type="checkbox" checked><?php echo $mod_strings['LBL_PUBLIC']; ?>
			<?php } ?>	
			</td>
			</tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
		<tr>
			<td>
				...
				{
				?>
				<a href="" id="actdelete" onclick ="fninvsh('eventcalAction');return confirm('<?php echo $app_strings['SURE_TO_DELETE'] ?>');" class="calMnu">- <?php echo $mod_strings['LBL_DEL']?></a>
				<?php
				}
				?>
			</td>
...
<input type="hidden" name="return_module" value="Calendar">
  ...
  <input type="hidden" name="maintab" value="Calendar">
	...
	<table align="center" border="0" cellpadding="0" cellspacing="0" width="95%" bgcolor="#FFFFFF">
		...
		<?php $vision = "block" ; } else {$vision = "block" ;} ?>
		</DIV>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
				...
				<?php
					...
					<?php } ?>		
                                ...
                                {
                                ?>
                                <a href="" id="taskactdelete" onClick ="fninvsh('taskcalAction');return confirm('<?php echo $app_strings['SURE_TO_DELETE'] ?>');" class="calMnu">- <?php echo $mod_strings['LBL_DEL']?></a>
                                <?php
                                }
                                ?>
