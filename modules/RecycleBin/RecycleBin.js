...
//TAM	if(confirm(mod_alert_arr.MSG_RESTORE_CONFIRMATION + " " + xx + " " + selectmodule + "?"))
	if(confirm( xx + "" + mod_alert_arr.MSG_RESTORE_CONFIRMATION_MASS + "?"))
	{
		$("status").style.display="inline";
		new Ajax.Request(
       	        'index.php',
...
{
//TAM	if(confirm(mod_alert_arr.MSG_RESTORE_CONFIRMATION + " " + select_module + "?"))
