			...
			{queue: {position: 'end', scope: 'command'},
				...
				onComplete: function(response){
					...
					if(response.responseText.indexOf('SUCCESS') > -1){
						...
						$('seqSettings').innerHTML= '<table cellpadding="10" cellspacing="0" border="0" width="100%" class="vtResultPop small"><tr><td align="center">'+alert_arr.WIDGET_DELETED_SUCESS+'</td></tr></table>';
